...
#SEEDEMU_INTERNET_MAP_IMAGE='karlolson1/seedog:v1'
...
##############commented out some build steps and put in base image##############
        ...
        start_commands = ''
        special_commands ='' ##KO added special_commands
...
##############################End Modifications##########################################
        ...
        dockerfile += self._addFile('/start.sh', DockerCompilerFileTemplates['start_script'].format(startCommands = start_commands, specialCommands=special_commands))####KO added Special Commands#####
