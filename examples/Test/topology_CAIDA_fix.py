...
Makers.makeStubAs(emu, base, 131,   100, [None])
#Makers.makeStubAs(emu, base, 1239,  100, [None])
Makers.makeStubAs(emu, base, 132,  100, [None])
Makers.makeStubAs(emu, base, 127,  100, [None])
Makers.makeStubAs(emu, base, 128,  100, [None])
Makers.makeStubAs(emu, base, 129,  100, [None])
Makers.makeStubAs(emu, base, 133,  100, [None])

## Tier 1 ASes
Makers.makeTransitAs(base, 134, [101,100,102, 103, 105, 106], [(101, 100), (101,103), (101,105), (101,106), (101,102)] )
Makers.makeTransitAs(base, 135, [102, 100, 101, 103, 104, 105, 106], [(102, 100), (102, 101), (102, 103), (102, 104), (102, 105), (102, 106)] )
Makers.makeTransitAs(base, 136, [103,100, 101, 105, 106], [(103, 100), (103, 101), (103, 105), (103, 106)] )
Makers.makeTransitAs(base, 137, [104, 100, 101, 102, 103, 105, 106], [(104, 100), (104, 101), (104, 102), (104, 103), (104, 105), (104, 106)] )
Makers.makeTransitAs(base, 138, [105,100, 101, 102, 103, 106], [(105, 100), (105, 101), (105, 103), (105, 106), (105, 102)] )
Makers.makeTransitAs(base, 139, [106,100, 101, 103, 105], [(106, 100), (106, 101), (106, 103), (106, 105)] )

## Tier 2 Transit ASes
Makers.makeTransitAs(base, 176, [100, 101, 102, 103, 104, 105, 106, 107], [(100, 107),(101, 107),(102, 107),(103, 107),(104, 107), (107,105), (107,106)])
Makers.makeTransitAs(base, 178, [101, 102, 103, 104, 105], [(101, 102),(101, 103),(101, 104),(101, 105)])
Makers.makeTransitAs(base, 179, [101, 102, 103, 104, 106, 108], [(108, 102), (108, 104), (108, 106), (108, 103), (108, 101)])
Makers.makeTransitAs(base, 180, [100, 101, 102, 103, 104, 105, 106, 109], [(109, 100), (109, 101),(109, 102),(109, 103),(109, 104),(109, 105),(109, 106)])
Makers.makeTransitAs(base, 181, [101, 104, 105, 106, 110], [(110, 101), (110, 104),(110, 105),(110, 106)])

## Tier 2 Extended for Step 8 P2P Links
Makers.makeTransitAs(base, 148, [100, 101], [(100, 101)])
Makers.makeTransitAs(base, 152, [100, 102], [(100, 102)])
Makers.makeTransitAs(base, 156, [100, 103], [(100, 103)])
Makers.makeTransitAs(base, 130, [100, 106], [(100, 106)])
Makers.makeTransitAs(base, 157, [100, 101, 102, 103, 104, 105, 106], [(103, 100),(103, 101),(103, 102),(103, 104),(103, 105),(103, 106)])
Makers.makeTransitAs(base, 159, [100, 101, 102, 103, 105, 106], [(103, 100),(103, 101),(103, 102),(103, 105),(103, 106)])
Makers.makeTransitAs(base, 151, [100, 101, 102, 103, 104, 105, 106], [(103, 100),(103, 101),(103, 104),(103, 105),(103, 106),(103,102)])
Makers.makeTransitAs(base, 161, [101, 103, 105, 104], [(104, 101),(104, 103),(104, 105)])
Makers.makeTransitAs(base, 165, [101, 102, 104, 106], [(104, 101),(104, 102),(104, 106)])
Makers.makeTransitAs(base, 171, [100, 101, 102, 103, 105, 106], [(106, 100),(106, 101),(106, 102),(106, 103),(106, 105)])
Makers.makeTransitAs(base, 172, [100, 101, 102, 103, 105, 106], [(106,100), (106, 101),(106, 103),(106, 105), (106,102)])
Makers.makeTransitAs(base, 173, [101, 102, 103, 105, 106], [(106, 101),(106, 103),(106, 105), (106,102)])
Makers.makeTransitAs(base, 166, [101, 102, 103, 105, 106], [(105, 101),(105, 102),(105, 103),(105, 106)])
...
#Clique-stubs
Makers.makeStubAs(emu, base, 140,  100, [None])
Makers.makeStubAs(emu, base, 142, 100, [None])
Makers.makeStubAs(emu, base, 144,  100, [None])
Makers.makeStubAs(emu, base, 141,  100, [None])
Makers.makeStubAs(emu, base, 143,  100, [None])
Makers.makeStubAs(emu, base, 145,  100, [None])

#T1-134 "Stubs", E.g. Just 1 layer deep ASNs at T1
Makers.makeStubAs(emu, base, 146,  101, [None])
Makers.makeStubAs(emu, base, 147,  101, [None])
#Makers.makeStubAs(emu, base, 148,   101, [None]) # Turned to Transit
Makers.makeStubAs(emu, base, 149,  101, [None])
Makers.makeStubAs(emu, base, 150,  101, [None])
...
Makers.makeStubAs(emu, base, 153,  102, [None])
Makers.makeStubAs(emu, base, 154,  102, [None])
Makers.makeStubAs(emu, base, 155,  102, [None])
...
Makers.makeStubAs(emu, base, 158,  103, [None])
...
Makers.makeStubAs(emu, base, 162,   104, [None])
Makers.makeStubAs(emu, base, 163,  104, [None])
...
Makers.makeStubAs(emu, base, 167,  105, [None])
Makers.makeStubAs(emu, base, 168,  105, [None])
Makers.makeStubAs(emu, base, 169,  105, [None])
Makers.makeStubAs(emu, base, 170,  105, [None])
...
Makers.makeStubAs(emu, base, 177,  106, [None])
Makers.makeStubAs(emu, base, 175,  106, [None])
